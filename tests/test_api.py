...
class TestGetHealth:
    ...
    def test_has_required_fields(self, client: TestClient) -> None:
        ...
        assert "llamacpp_healthy" in body
    ...
    def test_llamacpp_healthy_false_by_default(self, client: TestClient) -> None:
        body = client.get("/health").json()
        assert body["llamacpp_healthy"] is False
